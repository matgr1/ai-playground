...
class ConvolutionInstanceNeuronIterable<NeuronT extends Neuron> implements SizedIterable<NeuronState<NeuronT>> {

    private final int width;
    private final int height;
    private final int depth;

    private final ConvolutionInstance<NeuronT>[] instances;

    private final int volumeSize;
    private final int planeSize;

    public ConvolutionInstanceNeuronIterable(int width,
                                             int height,
                                             int depth,
                                             ConvolutionInstance<NeuronT>[] instances) {
    ...
    public Iterator<NeuronState<NeuronT>> iterator() {
        ...
        List<ConvolutionInstance<NeuronT>> instanceList = Arrays.asList(instances);
